...
app_name="${1:-Codex Monitor 1.0.1 QA}"
bundle_identifier="${QA_BUNDLE_IDENTIFIER:-com.codexmonitor.qa.v101}"
marketing_version="${QA_MARKETING_VERSION:-1.0.1}"
build_number="${QA_BUILD_NUMBER:-101}"
